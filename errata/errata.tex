\documentclass[11pt,showframe,twoside,openright]{report}
...
\end{displayquote}
  ...
  Apart from the additive nature of the equation in reference (\hl{Eq. 4.2, p. 103}), the I-prior methodology is completely different from additive models or GAMs.
  ...
  The above has been explained in the second paragraph on \pageref{errata11}.

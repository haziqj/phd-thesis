...
\begin{itemize}
  ...
  Our computational work is encapsulated in the publicly available and well-documented \proglang{R} package \pkg{iprior} published on CRAN.
...
\begin{itemize}
  \item \hltodo[Rethink this.]{\textbf{Initialisation of EM or gradient-based methods}}.

...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(contour.df, , 2 + j): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in b[[year]]: subscript out of bounds}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in b[[year]]: subscript out of bounds}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in b[[year]]: subscript out of bounds}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: `quo` must be a quosure}}\end{kframe}
\end{knitrout}

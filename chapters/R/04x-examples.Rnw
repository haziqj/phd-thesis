...
@
<<IGF.plot.beta, echo = FALSE, fig.width = 7, fig.height = 3.65, fig.cap = "A comparison of the estimates for random intercepts and slopes (denoted as points) using the I-prior model and the standard random effects model. The dashed vertical lines indicate the fixed effect values.", fig.pos = "htbp">>=
@

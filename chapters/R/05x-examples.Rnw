...
<<plot.btb, echo = FALSE, fig.height = 7.5, fig.width = 8, out.width = "\\linewidth", fig.cap = "Caption.", fig.pos = "p", dev = "png", dpi = 300, cache = TRUE>>=
@
...
<<plot.temporal.btb, echo = FALSE, warning = FALSE, fig.height = 7.5, fig.width = 8, out.width = "\\linewidth", fig.cap = "Caption.", fig.pos = "p", dev = "png", dpi = 300, cache = TRUE>>=
@

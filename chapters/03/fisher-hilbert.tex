...
To discuss derivatives of the log-likelihood function for $\theta\in\Theta$, we require a generalisation of the concept of differentiability from real-valued functions of a single, real variable, as is common in calculus, to functions between Hilbert spaces.
...
\begin{remark}
  Since $\d f(x)$ is a bounded, linear operator, by \hltodo{Lemma X}, it is also continuous. 
\end{remark}

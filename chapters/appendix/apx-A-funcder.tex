\index{entropy}
We present the functional derivative of the entropy $H(p)$ in {\color{\mycitecolour}Equation} \ref{eq:entrop} \colp{\mypageref{eq:entrop}}.

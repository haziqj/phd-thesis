...
Of interest are their probability density functions, first and second moments, and entropy \colp{\cref{def:entropy}, page \pageref{def:entropy}}.
...
\index{Fisher information!multivariate normal}
\begin{lemma}
...
\label{apx:gammadist}\index{gamma}
\vspace{-0.2em}
...
\label{def:invgam}\index{inverse gamma}
\vspace{-0.2em}

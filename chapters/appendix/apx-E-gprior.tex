...
With this inner product and from \cref{eq:fisher-linear-functional} \colp{\mypageref{eq:fisher-linear-functional}}, the Fisher information on $\boldsymbol{\beta}$ is
\begin{align*}

...
This needed structure is given to us by assuming that our regression function for the normal model lies in some \gls{rkhs} $\cF$, with reproducing kernel $h:\cX \times \cX \to \bbR$.

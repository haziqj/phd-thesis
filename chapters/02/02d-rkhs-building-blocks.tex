...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/02-kernel_path_const}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/02-kernel_path_canonical}
...
\begin{figure}[hbt]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/02-kernel_path_pearson}

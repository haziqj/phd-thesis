...
\tikzstyle{line} = [draw, -implies,double distance=4pt, shorten >=0.5cm, shorten <=0.5cm]
...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1cm, auto]
    ...
    \path [line] (pd) -- node [text width=2.5cm,midway,above,align=center,yshift=0.2cm] {\cref{thm:moorea}} (rkhs);
  \end{tikzpicture}  
  \caption{Test}
\end{figure}

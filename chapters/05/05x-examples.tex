...
The linear I-probit model is seen to be comparable to logistic regression, linear and quadratic discrimant analysis, and  decision trees, yet provides a significant improvement over multiple linear regression.

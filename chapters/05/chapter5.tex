...
\begin{enumerate}
  ...
  \hltodo[Perhaps plot time vs $n$, for varying $m$, using simulated data in \pkg{iprobit}.]{}
...
\ifstandalone
  ...
  \input{05-apx-02-proofs}
  \input{05-apx-03-derivations1}
  \input{05-apx-04-derivations2}
\fi

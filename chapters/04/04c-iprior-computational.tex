...
The Nyström method provides the formulae for $\tilde u_i$ and $\tilde\bv_i$ \citep[sec. 8.1, eq. 8.2 and 8.3]{rasmussen2006gaussian} as
\begin{align*}
...
\index{kernel matrix!front loading|(}
...
\index{likelihood|see{log-likelihood}}
...
\index{maximum a posteriori|see{MAP estimate}}
\index{MAP estimate}
\index{penalised likelihood}
\begin{remark}
